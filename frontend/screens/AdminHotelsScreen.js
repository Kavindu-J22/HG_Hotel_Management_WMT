...
const AdminHotelsScreen = ({ navigation }) => {
    ...
    const approveHotel = async (id) => {
        Alert.alert(
            "Approve Hotel",
            "Are you sure you want to approve this hotel for tourists to see?",
            [
...
const styles = StyleSheet.create({
    ...
    card: {
        ...
        elevation: 4, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 6,
    },
    ...
    approveButton: {
        backgroundColor: '#43e97b', paddingVertical: 12, borderRadius: 8, alignItems: 'center',
    },
